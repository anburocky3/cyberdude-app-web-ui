...
export default function TestimonialSection() {
  return (
    <>
      <section className="bg-black  bg-linear-to-b from-gray-900 via-black to-black mt-10">
        <div className="container mx-auto px-4 py-10">
         ...
         bg-clip-text text-transparent"
          ...
          <p className=" text-gray-300 text-center mt-10 max-w-3xl mx-auto relative">
            ...
            <QuoteIcon className="text-gray-600/50 w-12 h-12 rotate-180 absolute hidden md:block left-[-100px] top-0" />
          </p>
