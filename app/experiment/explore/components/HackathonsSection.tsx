    ...
    return (
        <section id="hackathons" className="py-24 relative">
            <div className="container relative z-10 px-4">
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-16">
                    {hackathonTypes.map((type) => (
                        ...
                        >
                            ...
                            >
                                <div className="p-8 h-full flex flex-col bg-card rounded-lg text-center">
                                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 ${type.color === "primary" ? "bg-primary/10 text-primary border border-primary/20" :
                                        type.color === "accent" ? "bg-accent/10 text-accent border border-accent/20" :
                                    ...
                                    <div className="flex items-center justify-center gap-2 text-primary font-medium mt-6 group-hover:gap-3 transition-all">
                                        Explore Events
                ...
                <div
                    className="p-8 rounded-2xl bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-border"
                >
