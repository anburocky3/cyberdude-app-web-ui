...
const hackathonTypes = [
  {
    ...
    description:
      "Simple problem statements with guidance. Perfect for first-timers.",
    color: "primary",
    href: "/hackathon/beginner",
  },
  {
    icon: Users2,
    title: "Team Hackathons",
    description:
      "Collaborate, divide responsibilities, and communicate like real teams.",
    color: "accent",
    href: "/hackathon/team",
  },
  {
      ...
      <div className="container mx-auto relative z-10 px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {hackathonTypes.map((type) => (
            <div key={type.title}>
              <Link href={type.href} className="block h-full group">
                <div className="p-8 h-full flex flex-col items-start justify-center bg-zinc-900 rounded-lg transition duration-300 hover:-translate-y-0.75 border border-gray-900">
                  <div
                  ...
                  <p className="text-gray-400 flex-1">{type.description}</p>
        ...
        <div className="p-8 rounded-2xl bg-zinc-950/90 border border-gray-800">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit) => (
              <div
                key={benefit}
                className="p-4 rounded-lg bg-zinc-900 border border-gray-800 text-center hover:-translate-y-0.75 transition duration-300"
              >
