...
const programs = [
    ...
    },
    {
        ...
        description: "Build beautiful, responsive, and interactive user interfaces that users love.",
        features: [
    ...
    },
    {
        ...
        description: "Master server-side logic, APIs, and the systems that power modern applications.",
        features: [
